...
export const constructionWebEmail = (user) => `Hey <strong> There! </strong> <br> User: ${user.name} <br> Phone Number: ${user.phoneNumber} <br> Email: ${user.email}<br> Message: ${user.message} <br> Thanks <br> construction web`;
