...
const defaultConfig = {
  ...
  mongo: {
    seed: true,
    uri: 'mongodb+srv://adilsikandar:adil1234@cluster0.c77nh.mongodb.net/trigon1',
    options: {
      db: {
        safe: true,
      },
...
const environmentConfigs = {
  development: {
    mongo: {
      uri: process.env.MONGO_URI || 'mongodb+srv://adilsikandar:adil1234@cluster0.c77nh.mongodb.net/trigon1',
    },
    security: {
      saltRounds: 4,
    },
